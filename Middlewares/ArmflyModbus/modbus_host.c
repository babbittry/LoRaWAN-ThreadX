...
void ModbusHost_ReciveNew(uint8_t _data)
{
    ...
    */
    ...
    vMBPortTimersEnable();      /* disable 超时 timer */
...
{
    g_modh_timeout = 1;
    vMBPortTimersDisable();     /* disable 超时 timer */
}
...
*	形    参: _reg : 寄存器编号
*            _num : 寄存器个数n (每个寄存器2个字节)
*	返 回 值: true 表示成功。false 表示失败（通信超时或被拒绝）
*********************************************************************************************************
*/
bool ModbusHost_ReadParam_01H(uint16_t _reg, uint16_t _num)
{
    ...
    for (i = 0; i < NUM; i++)
    {
        ...
        while (1)				/* 等待应答,超时或接收到应答则break  */
        {
            ...
            if (g_tModbusHost.fAck01H > 0)  /* while loop */
            {
                break;		/* 接收到应答 */
            }
        }
...
bool ModbusHost_ReadParam_02H(uint16_t _reg, uint16_t _num)
{
    ...
    for (i = 0; i < NUM; i++)
    {
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck02H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck02H > 0)  /* for loop */
        {
            break;
        }
    }
...
bool ModbusHost_ReadParam_03H(uint16_t _reg, uint16_t _num)
{
    ...
    for (i = 0; i < NUM; i++)
    {
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck03H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck03H > 0)  /* for loop */
        {
            break;
        }
    }
...
bool ModbusHost_ReadParam_04H(uint16_t _reg, uint16_t _num)
{
    ...
    for (i = 0; i < NUM; i++)
    {
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck04H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck04H > 0)  /* for loop */
        {
            break;
        }
    }
...
bool ModbusHost_WriteParam_05H(uint16_t _reg, uint16_t _value)
{
    ...
    for (i = 0; i < NUM; i++)
    {
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck05H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck05H > 0)  /* for loop */
        {
            break;
        }
    }
...
bool ModbusHost_WriteParam_06H(uint16_t _reg, uint16_t _value)
{
    ...
    {	
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck06H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck06H > 0)  /* for loop */
        {
            break;
        }
    }
...
bool ModbusHost_WriteParam_10H(uint16_t _reg, uint8_t _num, uint8_t *_buf)
{
    ...
    {	
        ...
        while (1)
        {
            ...
            if (g_tModbusHost.fAck10H > 0)  /* while loop */
            {
                break;
            }
        }
        
        if (g_tModbusHost.fAck10H > 0)  /* for loop */
        {
            break;
        }
    }
