...
static void SendTxData(void)
{
  ...
  uint16_t humidity = 0;
  uint32_t i = 0;   /* AppData.BufferSize */
  int32_t latitude = 0;
  int32_t longitude = 0;
...
static void OnTxTimerLedEvent(void *context)
{
  HAL_GPIO_WritePin(USER_LED_GPIO_Port, USER_LED_Pin, GPIO_PIN_SET); /* LED_GREEN */
}
...
static void OnTxData(LmHandlerTxParams_t *params)
{
  ...
  if ((params != NULL))
  {
    ...
    {
      HAL_GPIO_WritePin(USER_LED_GPIO_Port, USER_LED_Pin, GPIO_PIN_RESET); /* LED_GREEN */
